import { Events, MessageReaction, User, Client, TextChannel } from "discord.js";
    ...
    if (user.id == "379032082472763392") {
      ...
      if (isEmojis) {
        ...
        await (channel as TextChannel).send(
          "Sir bouvette ne souhaitant pas avoir d'émojis à son nom, il n'a pas le droit d'en utiliser. Il a par conséquent été kick du serveur."
        );
      }
    }
  },
